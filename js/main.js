                ...
                data: {func: 'formatHD'},
                 success:function(data) {
                     if(data.status == 'OK'){
                        ...
                        openModal({title:modalInfo[0].title,text:modalInfo[0].text,btn:modalInfo[0].btn,input:generateModalInput([["act", "hd-format"]])});
	            ...
	            function generateCertificationDiv(opts, lang){
	                ...
	                if($var.hasClass('complete')){
	                    ...
	                    if($var.hasClass('learning')) {
	                        ...
	                        text += '</span>';
							// text = '<span class="btn btn-primary buycert" id="buy" value="'+opts.cert+'">'+lang.cert_free+'</span>';
	                    }
	                } else {
